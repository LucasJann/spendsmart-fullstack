...
describe("Button component", () => {
  it("renders button with correct text and class", () => {
    const { getByRole } = render(
      <Button id="button" type="button" className="btn-primary">
        Click me
      </Button>
    );
  ...
  it("renders as disabled when disabled is true", () => {
    const { getByRole } = render(
      <Button id="button" type="button" className="btn-primary" disabled={true}>
        Disabled Button
      </Button>
    );
    const button = getByRole("button");
  ...
  it("renders with correct type attribute", () => {
    const { getByRole } = render(
      <Button id="button" type="submit" className="btn-primary">
        Submit Button
      </Button>
    );
    const button = getByRole("button");
